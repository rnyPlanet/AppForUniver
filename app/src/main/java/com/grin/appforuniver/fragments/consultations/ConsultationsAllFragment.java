...
public class ConsultationsAllFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_consultations_all, container, false);

        recyclerView = mView.findViewById(R.id.fragment_consultations_all_rv);
        progressBar = mView.findViewById(R.id.fragment_consultations_all_pb);
    ...
    private void getAllConsultations() {
        LinearLayout emptyState = mView.findViewById(R.id.consultation_all_empty_state_layout);
